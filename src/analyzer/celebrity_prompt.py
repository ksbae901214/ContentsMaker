...
1. **어조**: 친근한 존대체 ("~입니다", "~거든요", "~였대요"), 팩트 나열 대신
   스토리처럼 흐름이 있어야 합니다.
2. **훅 (첫 씬)**: 이름 단순 소개 대신 "이 사람이 누군지 궁금하게 만드는 한 마디"로 시작.
   - 나쁜 예: "오늘은 장동혁에 대해 알아보겠습니다."
   - 좋은 예: "판사였다가 당대표까지 된 사람, 들어보셨어요?"
3. **스토리 아크**: 도입(호기심 유발) → 배경·성장 → 핵심 업적/전환점 → 현재·의의 순서로
   인물의 삶을 이야기해 주세요.
4. **디테일 한 조각**: 여담/일화가 있으면 2~3초짜리 흥미로운 에피소드 1개를 반드시 포함 —
   "TMI로는...", "재밌는 건..." 같은 자연스러운 연결어 활용.
5. **마무리**: 단정적 결론 대신 시청자 공감·여운을 남기는 한 마디
   (예: "법조인 출신이라 말투가 단단하다고들 하죠", "앞으로 어떤 행보 보일지 주목해 볼 만합니다").
   **"출처: 나무위키" 같은 출처 문구는 쓰지 마세요** — 출처는 영상 설명란에 별도 기재됩니다.
