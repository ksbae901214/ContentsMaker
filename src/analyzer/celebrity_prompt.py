...
10. **50~70초 분량**, 씬 하나당 **최대 5초**, **총 12~15씬**:
    - ⚠️ 모든 씬의 duration은 반드시 5초 이하
    - voice_text가 5초를 넘으면 두 개 이상의 씬으로 분할
    - 한 씬 voice_text는 한국어 ~20자 이하 (TTS rate +20%)
    - **씬 수 12~15개를 목표**로 하여 인물의 생애·업적·디테일을 풍부하게 다룸
    - [A] 훅 + 기본 소개 2~3씬
    - [B] 학력·성장 과정 3~4씬 (출생지, 학교, 첫 직업, 결정적 계기 등 구체적으로)
    - [C] 주요 경력·업적 + 현재 활동 4~6씬
      (시간순으로 핵심 경력 + "현재는 ~" 명시 + 여담·TMI 1~2개)
    - [D] 마무리 1~2씬 (여운·공감 한 마디, 출처 표기 X)
    - **정보가 부족해도 절대 4~5씬으로 짧게 끝내지 말고**, 가용한 팩트를 잘게
      쪼개서라도 12씬 이상 채울 것
